...
\For{each sub-problem which corresponds to a lecture}{
	...
	\While{the topic of the lecture is not covered}{
		Small quiz on a piece of the lecture (socrative or kahoot or clicker)\;
		Ask students to implement and test this piece of software\;
		Show your solution\;
		Rhetorical quiz (Put the correct the answers next to ridiculous false answers in order to some up the part)
